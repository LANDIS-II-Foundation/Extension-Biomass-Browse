...
Source: {#BuildDir}\Landis.Extension.Browse-v2.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.Browse-v2.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Biomass Browse 2.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Biomass Browse"" "; WorkingDir: {#LandisPlugInDir}
