...
Source: {#BuildDir}\Landis.Extension.Browse-v3.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.Browse-v3.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Biomass Browse 3.txt"
