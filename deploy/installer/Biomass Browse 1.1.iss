...
Source: {#BuildDir}\Landis.Extension.Browse-v1.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.Browse-v1.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Biomass Browse 1.1.txt"
