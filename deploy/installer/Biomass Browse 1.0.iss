...
[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Browse"" "; WorkingDir: {#LandisPlugInDir}
...
Filename: {#ExtensionsCmd}; Parameters: "remove ""Deer Browse"" "; WorkingDir: {#LandisPlugInDir}
