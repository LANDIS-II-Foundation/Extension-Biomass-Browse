...
#define ExtensionName "Biomass Browse"
...
AppId={{E4DCF02E-87BC-4E7A-8D78-0F16399F80F8}
...
Source: {#BuildDir}\Landis.Extension.Browse-v2.1.dll; DestDir: {#ExtDir}; Flags: replacesameversion
Source: {#BuildDir}\Landis.Extension.Browse-v2.1.pdb; DestDir: {#ExtDir}; Flags: replacesameversion
...
Source: {#BuildDir}\Landis.Library.Biomass-v2.1.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
Source: {#BuildDir}\Landis.Library.BiomassCohorts-v4.dll; DestDir: {#ExtDir}; Flags: uninsneveruninstall replacesameversion
...
#define InfoTxt "Biomass Browse 2.1.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Biomass Browse v2.1"" "; WorkingDir: {#LandisPlugInDir}
