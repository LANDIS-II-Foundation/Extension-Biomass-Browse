...
#define ExtensionName "Deer Browse"
...
AppId={{4FFA20EE-8C99-40DB-A573-85AD5275B3AF}
...
Source: {#BuildDir}\Landis.Extension.DeerBrowse-v4.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Deer Browse 4.0.txt"
